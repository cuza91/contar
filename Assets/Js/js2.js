...
function sabermn1() {
  let mn = 0;
  mn =
    parseFloat(document.getElementById("m1000").value * 1000) +
...
function saberusd1() {
  let usd = 0;
  usd =
    parseFloat(document.getElementById("i1000").value * 1000) +
...
function totalcup1() {
  return (
    sabermn1() +
    saberusd1() * parseFloat(document.getElementById("tasa2").value)
  );
}
...
function totalusd1() {
  return (
    saberusd1() +
    sabermn1() / parseFloat(document.getElementById("tasa2").value)
  );
}
