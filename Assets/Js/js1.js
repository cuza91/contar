...
function sabermn() {
  let mn = 0;
  mn =
    parseFloat(document.getElementById("b1000").value * 1000) +
...
function saberusd() {
  let usd = 0;
  usd =
    parseFloat(document.getElementById("u1000").value * 1000) +
...
function totalcup() {
  return (
    sabermn() +
    saberusd() * parseFloat(document.getElementById("tasa-cambio").value)
  );
}
...
function totalusd() {
  return (
    saberusd() +
    sabermn() / parseFloat(document.getElementById("tasa-cambio").value)
  );
}
